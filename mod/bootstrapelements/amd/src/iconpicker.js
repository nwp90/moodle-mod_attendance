...
(function($) {
    ...
    Iconpicker.prototype = {
        ...
        _bindElementEvents: function() {
            ...
            if (this.hasInput()) {
                ...
                this.input.on('keyup.iconpicker', function(e) {
                    ...
                    if (!_helpers.inArray(e.keyCode, keyCodes)) {
                        _self.update();
                    } else {
        ...
        _bindWindowEvents: function() {
            ...
            $(window).on('resize.iconpicker' + _eventNs + ' orientationchange.iconpicker' + _eventNs, function() {
                // reposition popover
        ...
        updatePlacement: function(placement, collision) {
            ...
            if (typeof placement === 'object') {
                // custom position ?
                return this.popover.position($.extend({}, _pos, placement));
            }
