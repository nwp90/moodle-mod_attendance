...
$string['settings_general_heading'] =
    'General Settings';

$string['setting_host_label'] = 'eReserve Plus Host Name:';
$string['setting_host_desc'] =
    'This setting is the full qualified domain for your eReserve Plus instance (e.g. eu-moodle.ereserve.com.au).<br/>' .
    '<span style="font-weight: bold">NB:</span> Please do not include the http:// or https:// portion of the URL<br/>' .
    '<br/>';

$string['setting_ims_lti_heading'] =
    'IMS LTI Settings';
$string['setting_ims_lti_desc'] =
    '<p>' .
...
$string['setting_consumer_key_desc'] =
    'The <span style="font-weight: bold">Key</span> from the associated integration record in eReserve Plus<br/>' .
    '<br/>';

$string['setting_shared_secret_label'] = 'Shared Secret';
$string['setting_shared_secret_desc'] =
    'The <span style="font-weight: bold">Secret</span> from the associated integration record in eReserve Plus<br/>' .
    '<br/>';

$string['host_missing_error'] = 'Missing Host: Please provide the host for your eReserve Plus instance to complete the settings';
$string['missing_lti_settings'] =
    '<div style="padding:20px;width:100%;font-size:14px;color:red">' .
...
$string['setting_development_heading'] =
    'Development Setting';
$string['setting_development_desc'] =
    '<p>' .
