 ...
 * @return bool result
 */
function xmldb_format_medschool_topics_upgrade($oldversion) {
    global $CFG, $DB;
    ...
    if ($oldversion < 2017020200) {
        ...
        upgrade_plugin_savepoint(true, 2017020200, 'format', 'medschool_topics');
    }
    ...
    if ($oldversion < 2017111301) {
        ...
        (SELECT id FROM {course} WHERE format=?)", ['medschool_topics']);

        upgrade_plugin_savepoint(true, 2017111301, 'format', 'medschool_topics');
    }
