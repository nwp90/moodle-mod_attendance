        ...
        init: function (ed, pluginUrl) {
            ...
            ed.onBeforeSetContent.add(function(ed, o) {
                ...
                o.content = o.content.replace(
                    existing_course_id_regex,
                    'local/ereserve_plus/resource_link/show.php?course_id=' + course_id
                );
            });
            ...
            window.addEventListener('message', function (e) {
                if (debug) {
                    ...
                    if (e.origin !== instance_url) {
                        console.log('ERESERVE DEBUG: atto_ereserve: ERROR bad origin got "' + e.origin + '" expected "' + instance_url + '"');
                    }
